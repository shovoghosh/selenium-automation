...
public class TestItem4 {
	...
	public static void main(String[] args) throws InterruptedException {
		//Clicked on Faculty of Engineering, the system displays a page titled Faculty of Engineering
				...
				WebElement one=driver.findElement(By.xpath("//*[@id=\"menu-primary-navigation\"]/li[5]/ul/li[3]/a"));
				...
				if(itemonecopy.equals("Faculty of Engineering")) 
				{
